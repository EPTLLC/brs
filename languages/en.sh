...
NET_ARP_SCANNING="🔍 Performing ARP scan..."
NET_HOSTS_FOUND="✅ Live hosts found"
NET_LIVE_HOSTS="📋 LIVE HOSTS:"
NET_PORT_SCANNING="⚡ Fast port scanning..."
NET_SCANNING_HOST="🎯 Scanning"
NET_SCAN_COMPLETE="✅ Scan completed!"
NET_RESULTS_SAVED="📁 Results saved to:"
NET_LIVE_HOSTS_FILE="- Live hosts"
NET_SCAN_RESULTS_FILE="- Scan results"
NET_STATISTICS="📊 SUMMARY STATISTICS:"
...
VULN_AUTO_SCAN="Auto-scan all discovered hosts"

# Attack Tools
ATTACK_TITLE="⚔️ ATTACK TOOLS"
ATTACK_WARNING="⚠️ AUTHORIZED TESTING ONLY!"
ATTACK_BRUTEFORCE="Bruteforce attacks:"
ATTACK_SSH_BRUTE="SSH bruteforce"
ATTACK_FTP_BRUTE="FTP bruteforce"
ATTACK_HTTP_BRUTE="HTTP Basic Auth bruteforce"
ATTACK_TELNET_BRUTE="Telnet bruteforce"
ATTACK_RDP_BRUTE="RDP bruteforce"
ATTACK_NETWORK="Network attacks:"
ATTACK_ARP_SPOOF="ARP Spoofing"
ATTACK_MITM="MITM attack (ettercap)"
...
ATTACK_WORDLIST_GEN="Wordlist generation"
...
LANG_CHANGE_SUCCESS="✅ Language successfully changed!"
LANG_RESTART_REQUIRED="Please restart the application to apply changes."

# Company Information (US/UK specific)
...
# US/UK Legal Framework
US_COMPUTER_FRAUD_ACT="Computer Fraud and Abuse Act (18 U.S.C. § 1030)"
US_WIRETAP_ACT="Electronic Communications Privacy Act (18 U.S.C. § 2511)"
US_DMCA="Digital Millennium Copyright Act"
UK_COMPUTER_MISUSE_ACT="Computer Misuse Act 1990"
UK_DATA_PROTECTION_ACT="Data Protection Act 2018"

# Legal and Ethics Messages (US/UK specific)
...
LEGAL_CRIMINAL_CHARGES="• Criminal charges under Computer Fraud and Abuse Act (CFAA) and Computer Misuse Act"
LEGAL_SUBSTANTIAL_FINES="• Substantial fines (potentially millions of dollars depending on damage)"
LEGAL_PRISON_TIME="• Imprisonment (up to 20 years in US, up to 10 years in UK depending on severity)"
LEGAL_CRIMINAL_RECORD="• Permanent criminal record affecting future employment, travel, and reputation"
...
LEGAL_PENETRATION_CONTRACTS="• Within signed penetration testing contracts"
LEGAL_BUG_BOUNTY="• Within legitimate bug bounty programs"
LEGAL_EDUCATIONAL_ENVIRONMENTS="• In controlled educational environments under supervision"
LEGAL_DISCLAIMER_LIABILITY="COMPLETE DISCLAIMER OF LIABILITY:"
LEGAL_EASYPROTECH_DISCLAIMER="$COMPANY_NAME, its officers, employees and contributors provide this software \"AS IS\" WITHOUT ANY WARRANTIES and ARE NOT LIABLE for any damage, harm, legal consequences or misuse. Users accept FULL RESPONSIBILITY and agree to indemnify $COMPANY_NAME."
LEGAL_READ_BEFORE_USE="READ BEFORE USE: See LEGAL.md, ETHICS.md and DISCLAIMER.md for complete terms."
LEGAL_US_UK_DISCLAIMER="📌 US/UK LEGAL DISCLAIMER"
LEGAL_US_UK_USER_CONFIRMS="User confirms that:"
LEGAL_US_UK_EDUCATIONAL_ONLY="• Uses the software ONLY for educational or research purposes, on OWN devices or with written permission from system owners"
LEGAL_US_UK_UNDERSTANDS_LAW="• Understands that unauthorized access to computer systems falls under CFAA (US) and Computer Misuse Act (UK), with severe criminal penalties"
LEGAL_US_UK_FULL_RESPONSIBILITY="• Takes full legal and civil responsibility for consequences of software use"
LEGAL_US_UK_COMPLIANCE="• Commits to comply with requirements of CFAA, ECPA, Data Protection laws, and other applicable IT security regulations"

# Language selection interface  
LANG_SELECTION_HEADER="🌍 LANGUAGE SELECTION"
LANG_SELECTION_PROMPT="Select language"
LANG_AGREEMENT_DISPLAY="I AGREE" 
LANG_EXIT_DISPLAY="EXIT"
...
LEGAL_DECLARATION_INTRO="By continuing, you declare under penalty of perjury that:"
LEGAL_DECLARATION_OWNERSHIP="1. You will use this software ONLY on networks and systems you own or have explicit written permission to test"
...
LEGAL_DECLARATION_LAWS="4. You have studied applicable laws in your jurisdiction"
LEGAL_DECLARATION_REVOCATION="5. You will cease use immediately if permission is revoked"
...
CONTACT_COOPERATION_AUTHORITIES="$COMPANY_NAME is ready for full cooperation with US/UK law enforcement agencies"

# Licensing Information (US/UK specific)
...
LICENSE_GPLV3_DESC="For educational, research, personal and open projects"
LICENSE_COMMERCIAL_DESC="For commercial enterprises, proprietary projects, closed derivatives"
...
LICENSE_DEFAULT_GPLV3="Default: GPLv3 applies if commercial license not obtained"
LICENSE_COMMERCIAL_NEGOTIATION="Commercial licenses: individual negotiations via Telegram"
LICENSE_NO_SUPPORT_PROVIDED="Support is NOT PROVIDED in any form"

# US/UK Jurisdiction
JURISDICTION_PRIMARY="Primary jurisdiction: $COMPANY_JURISDICTION"
JURISDICTION_APPLICABLE_LAWS="Applicable laws: United States/United Kingdom (primary), local laws (additional)"
JURISDICTION_COOPERATION="$COMPANY_NAME cooperates with US/UK authorities when necessary"
JURISDICTION_US_UK_COURTS="Disputes: US Federal Courts / UK Courts (for respective citizens)"
...
WARN_NETWORK_IMPACT="This operation may affect network performance"
...
TIMEOUT_TIMED_OUT_AFTER="⚠️ Scan terminated due to timeout after"
TIMEOUT_SCAN_FAILED="❌ Scan failed"
TIMEOUT_SCAN_COMPLETED="✅ Scan completed"
TIMEOUT_SCAN_TIMED_OUT="Scan terminated due to timeout"
TIMEOUT_RUNNING_WITH="⏱️ Running with timeout:"
TIMEOUT_OPERATION_CANCELLED="Operation cancelled due to timeout"

# Port Connectivity Check Messages
CONNECTIVITY_CHECKING="🚧 Checking target availability"
...
CONNECTIVITY_SUCCESS="✅ Port available, starting attack..."
...
NET_TOOLS_INSTALL_HINT="Install: sudo apt install nmap arp-scan"
ERROR_INVALID_NETWORK="❌ Invalid network format! Use format: 192.168.1.0/24"
NET_VALIDATING_NETWORK="🔍 Validating network format..."
NET_AVAILABLE_NETWORKS="📡 Available networks:"
NET_SELECT_NETWORK="Select network for scanning:"
NET_ENTER_CUSTOM="Enter network manually (CIDR format):"
NET_NETWORK_INFO="Network information:"
...
NET_PARALLEL_LIMIT="⚡ Parallel scanning limit"
...
NET_NO_TOOLS_WARNING="⚠️ Limited functionality: Install nmap and arp-scan for full capabilities"
...
SYSINFO_COMPLETE="✅ System analysis complete"
...
SYSINFO_MEMORY_USED="Memory Used:"
SYSINFO_MEMORY_FREE="Memory Free:"
...
SYSINFO_MENU_SYSTEM="System Information Only"
SYSINFO_MENU_HARDWARE="Hardware Information Only"
...
ATTACK_WARNING_TEXT="These tools are intended ONLY for security testing of YOUR OWN network!"
ATTACK_WARNING_ILLEGAL="Use against others' systems without permission is ILLEGAL!"
ATTACK_CONTINUE_PROMPT="Continue? (y/N):"
ATTACK_OPERATION_CANCELLED="Operation cancelled"
ATTACK_WORDLIST_CREATE="Password wordlist creation"
ATTACK_DIR_BRUTE="Directory/file discovery"
ATTACK_MALICIOUS_PDF="Malicious PDF generation"
ATTACK_TARGET_PROMPT="Enter target (IP):"
ATTACK_TARGET_NOT_SPECIFIED="❌ Target not specified"
ATTACK_CREATING_WORDLISTS="📝 Creating wordlists..."
ATTACK_WORDLISTS_CREATED="✅ Wordlists created in"
...
ATTACK_WORDLIST_PATH="Password wordlist path:"
ATTACK_FILE_NOT_FOUND="❌ File not found"
ATTACK_DOS_WARNING="⚠️ DoS attack may disrupt network operation!"
ATTACK_PORT_PROMPT="Attack port (default 80):"
ATTACK_DURATION_PROMPT="Attack duration in seconds (default 30):"
ATTACK_DOS_STARTING="💥 SYN Flood attack on"
ATTACK_DOS_COMPLETE="✅ DoS attack complete"
...
PORT_STEALTH_SCAN="Stealth SYN scanning"
PORT_UDP_SCAN="UDP scanning"
PORT_VERSION_SCAN="Service version detection"
PORT_AGGRESSIVE_SCAN="Aggressive scanning (-A)"
PORT_TOR_SCAN="Scanning via Tor (if available)"
PORT_MASS_SCAN="Mass fast scanning (masscan)"
...
VULN_SMB_SCAN="SMB vulnerability scanning"
VULN_SSH_WEAK="SSH weak password testing"
VULN_FTP_WEAK="FTP weak password testing"
VULN_TELNET_WEAK="Telnet weak password testing"
VULN_OPEN_SHARES="Search for open shares (SMB/NFS)"
VULN_SSL_TLS="SSL/TLS vulnerability testing"
VULN_COMPREHENSIVE="Comprehensive vulnerability scanning"
...
VULN_SQLMAP_SCANNING="💉 SQLmap SQL injection scanning"
VULN_SMB_SCANNING="📁 SMB vulnerability scanning"
VULN_SSH_TESTING="🔑 SSH weak password testing"
VULN_FTP_TESTING="📁 FTP weak password testing"
VULN_TELNET_TESTING="📺 Telnet weak password testing"
VULN_SHARES_SCANNING="🔍 Open shares scanning"
...
# Configuration limits and network messages
NET_MAX_NETWORK_SIZE_WARNING="Network too large for safe scanning"
NET_MAX_PARALLEL_SCANS_INFO="Parallel scanning limit reached"
